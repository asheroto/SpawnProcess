Module Program
    ...
    Sub PrintHelpTextAndEnd()
        Console.WriteLine("SpawnProcess.exe -path ""C:\Path\To\Process.exe"" -args ""-arg1 goesHere -arg2 goesHere"" -windowstyle hidden|normal|minimized|maximized -workingdirectory ""C:\Path\To""")
        Console.WriteLine("")
        Console.WriteLine("or if on Linux/Mac, specify /path/to/process like that")
        Console.WriteLine("")
        Console.WriteLine("-args And -windowstyle And -workingdirectory are optional")
        Console.WriteLine("")
        End
    End Sub
